        ...
        <>
            <div className={Style.main}>
                ...
                <div className={Style.categories}>
                        ...
                        <div className={Style.categories_mid_items}>
                            <div className={Style.categories_mid_item}>
                                <div className={Style.categories_mid_item_top}>
                                    <img src="./dish_item.svg" alt="dish_item" />
                                </div>
                                ...
                                <div className={Style.categories_mid_item_bottom}>
                                    <div className={Style.categories_mid_item_bottom_controler}>
                                        <div className={Style.categories_mid_item_bottom_controler_left}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="16"
                                                height="16"
                                        ...
                                        <div className={Style.categories_mid_item_bottom_controler_mid}>
                                            1
                                        </div>
                                        <div className={Style.categories_mid_item_bottom_controler_right}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="16"
                                                height="16"
                                    ...
                                    <button className={`button_main ${Style.categories_mid_item_bottom_add}`}>
                                        Add
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className={Style.categories_bottom}></div>
                </div>
            </div>
        </>
    );
