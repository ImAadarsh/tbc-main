    ...
    return (
        <>
            <div className={Style.categories_mid_item}>
                <div className={Style.categories_mid_item_top}>
                ...
                <div className={Style.categories_mid_item_bottom}>
                    <div className={Style.categories_mid_item_bottom_controler}>
                        <div
                            onClick={() => { props.itemIncDec(-1) }}
                            className={
                                `${Style.categories_mid_item_bottom_controler_left} ${props.itemCount > 1 && Style.categories_mid_item_bottom_controler_right}`
                            }
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
